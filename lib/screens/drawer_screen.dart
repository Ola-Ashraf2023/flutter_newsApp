            ...
            child: InkWell(
              ...
              child: Row(
                children: [Padding(
                  ...
                  child: Icon(Icons.list,color: Color(0xff303030),),
                ),
                  Text("Categories",style: GoogleFonts.poppins(color: Color(0xff303030),fontWeight: FontWeight.w700,fontSize: 27),)],
              ),
            ),
          ),
          Padding(
            ...
            child: Row(
              children: [Padding(
                padding: const EdgeInsets.all(16.0),
                child: Icon(Icons.settings,color: Color(0xff303030),),
              ),Text("Settings",style: GoogleFonts.poppins(color: Color(0xff303030),fontWeight: FontWeight.w700,fontSize: 27))],
            ),
          ),
        ],
      ),
